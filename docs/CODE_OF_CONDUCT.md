...
This project supports decisions about germplasm and breeding programmes,
so scientific honesty is part of conduct rather than separate from it.
Community members are expected to:

- report a defect that affects a returned number, even when it is their
  own;
- state the assumptions and limitations of a proposed method rather than
  only its strengths;
- not overstate what an analysis demonstrates; and
- respect the confidentiality of germplasm, phenotype and pedigree data
  belonging to others, and never post such data in an issue or pull
  request.
