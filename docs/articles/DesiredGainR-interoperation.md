...
It does not analyse field designs, estimate marker effects, allocate
crosses or optimise matings. Keep those responsibilities in the
specialised software that produced or consumes the corresponding
objects.
...
objective used. Do not send only a sorted list: mating-design software
needs enough information to apply diversity, relationship and crossing
constraints that are outside the selection index.
